...
public class GameObject {
    ...
    public void render(Graphics2D g) {
        ...
        if (GameEngine.getSelectedScene().isEditing() && editorComponent.isStarted()) editorComponent.render(g);
    }
    ...
    public void setMouseInside(final boolean isMouseInside) {
